  ...
  return (
    <main className="login-shell">
      ...
      <section className="login-card">
        <div className="login-brand"><img src="/crosscomply-logo.svg" alt="" className="login-brand__mark" /><div><strong><span>Cross</span><em>Comply</em></strong><small>跨境数据合规案件工作台</small></div></div>
        ...
        <form onSubmit={submit} className="login-form">
          ...
          <label className="form-field"><span>访问密码</span><input type="password" value={password} onChange={(event) => setPassword(event.target.value)} placeholder="输入工作台密码" autoComplete="current-password" required /></label>
